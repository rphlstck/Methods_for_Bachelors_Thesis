...
# older version of function not necessarily compatible with 'a' (matching array) if 'a' is created via create_matching_for_embedded
...
def make_frequency_plot_for_num_of_clusters_in_HII_regions(dic, path=None, save=False, name=r'\frequency_of_number_of_clusters_in_HII_regions.png', plot=False):
    '''
